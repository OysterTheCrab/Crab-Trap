...
execute if score $sleep OtcFishingSleep matches 1 if score $day OtcFishingSleep matches 1 if score $check OtcFishingSleep matches 0 at @s run function otc_fishing:crab_trap/catch
