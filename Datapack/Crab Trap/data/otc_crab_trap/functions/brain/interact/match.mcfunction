...
execute if score $differs otcInteract matches 0 if entity @s[tag=OtcCrabTrapNotReady,tag=!OtcCrabTrapReady] run function otc_crab_trap:brain/interact/error
execute if score $differs otcInteract matches 0 if entity @s[tag=OtcCrabTrapReady,tag=!OtcCrabTrapNotReady] run function otc_crab_trap:brain/interact/reward_and_reset
